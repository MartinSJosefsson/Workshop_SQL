...
SELECT city.Name AS nm , city.District AS dist FROM city WHERE CountryCode = "arm"; 
#
# 7: Get the cities with a name that starts with "bor"
SELECT * FROM city WHERE city.Name LIKE "bor%";
#
# 8: Get the cities with a name that contains the string "orto"
SELECT * FROM city WHERE city.Name LIKE "%orto%";
#
...
SELECT country.Name , country.IndepYear	FROM country WHERE indepyear < 0;
#
